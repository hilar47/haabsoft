														...
														if(jQuery.trim(phone).length != 0){
															if(phone.length >= 10){
													            ...
													            jQuery.ajax({
													                url: url,
													                type: "POST",
													                data: { first_name: first_name, last_name: last_name,user_email: user_email,password: password,c_password: c_password,address_1: address_1,address_2: address_2,country: country,city: city,pin_code: pin_code,phone: phone,model_hid_id: model_hid_id },
