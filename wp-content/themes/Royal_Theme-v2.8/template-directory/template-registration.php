...
<div class="container register p-v-80">
    ...
    <div class="col-sm-offset-1 col-sm-10 m-t-80">
        <div class="row">
            <div class="col-sm-4">
            	<div class="panel">
            ...
            <div class="col-sm-4">
            	<div class="panel">
                    ...
                    <p class="text-center">Lorem ipsum dolor sit amet, consecte adipisicing elit, sed do eiusmod  incididunt ut</p>
                     <a href="<?php echo site_url() . '/client'; ?>"><button type="submit" class="btn btn-block btn-primary">Create user profile</button> </a>
                 </div>
            </div>
            <div class="col-sm-4">
            	<div class="panel">
                    ...
                    <p class="text-center">Lorem ipsum dolor sit amet, consecte adipisicing elit, sed do eiusmod  incididunt ut</p>
                     <a href="<?php echo site_url() . '/promoter'; ?>"><button type="submit" class="btn btn-block btn-primary">Create user profile</button> </a>
                 </div>    
            </div>
        </div>
	</div>
